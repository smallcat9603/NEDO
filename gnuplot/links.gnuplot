...
set ylabel "Number of Links" font ",20"

plot  'C:\Users\smallcat\Dropbox (å¬êl)\eclipse\common_workspace\NEDO\links.txt' using ($2):xtic(1) title "2-D mesh", '' using ($3) title "2-D torus", '' using ($4) title "generator"

#set terminal png         # gnuplot recommends setting terminal before output
#set output 'C:\Users\smallcat\Dropbox (å¬êl)\eclipse\common_workspace\NEDO\links.png'  

set term post eps color "GothicBBB-Medium-RKSJ-H, 20"  
#set term post eps color     
set output 'C:\Users\smallcat\Dropbox (å¬êl)\eclipse\common_workspace\NEDO\links.eps'  
replot
